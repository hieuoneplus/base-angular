...
import { ComponentAbstract, converDateToDate, convertDateFromServer, HttpResponse, MessageSeverity, ToastService } from "@shared-sm";
...
export class HistoryComponent extends ComponentAbstract {
  ...
  constructor(
    ...
    private blacklistService: CitadBlacklistService,
  ...
  handleGetList(): Observable<HttpResponse<PaginationQueryTransactionCitadDto<IAccountContent>>> {
    ...
    return this.blacklistService.getHistories(this.options.params).pipe(
